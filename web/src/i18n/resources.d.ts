...
export default interface Resources {
  ...
  "inspector": {
    ...
    "panel": {
      ...
      "flipVertical": "垂直",
      "flipped": "已翻转",
      "frameLegacyAdopt": "改用原图的图幅",
      "frameLegacyBody": "这张图在排版上仍按 figsize 显示；脚本保存时把它裁成了 {{w}} × {{h}} mm，边上的标签才完整。改用那个图幅后，图在排版上的位置不变，只是外框变化。",
      "frameLegacyTitle": "与脚本保存的原图大小不同",
      "geometry": "位置与尺寸",
      "image": "图片",
      "loading": "加载中…",
      "lockAspect": "锁定宽高比",
  ...
  "workspace": {
    ...
    "panelBadge": {
      ...
      "error": "渲染失败",
      "firstBuild": "首次构建中…",
      "frameLegacy": "按 figsize 显示",
      "frameLegacyHint": "脚本保存的原图裁得不一样。选中这张图，在右侧属性里可以改用原图的图幅。",
