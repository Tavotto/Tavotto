...
export default interface Resources {
  ...
  "dialogs": {
    ...
    "registry": {
      ...
      "canRegister": "可登记：",
      "candidatesTitle": "未登记的绘图脚本",
      "conflictHint": "在下面把该 stem 填给其中一个脚本即可；另一个脚本对它的认领会自动摘掉。",
      "conflictScripts": "：{{scripts}}",
      "conflictsTitle": "归属冲突（未分配，需要你裁决）",
      "emptyHint": "先「重新扫描」；文件名只有运行时才知道的脚本用「试运行」登记。",
      "emptyTitle": "注册表是空的",
      "entry": "入口 {{entry}}",
      "introAfter": "（可参数化编辑）。注册表存在图库目录的 tavotto_registry.json，随图库走。",
      "introBefore": "登记过的脚本，它产出的面板才带",
      "manualAria": "{{script}} 的 stem",
      "manualPlaceholder": "或手工填 stem，逗号分隔",
      "noCandidates": "没有发现未登记的脚本。",
      "none": "—",
      "nothingNew": "扫描完成，没有发现新的可登记脚本",
      "probeAndRegister": "试运行并登记",
      "probeDropped_other": "另有 {{count}} 张图超过捕获上限未显示",
      "probeFailed": "{{script}} 试运行失败：{{error}}",
      "probeRegistered": "已登记 {{stems}}",
      "probeTraceback": "诊断详情",
      ...
      "register": "登记",
      "registeredTitle_other": "已登记（{{count}}）",
      "registered_other": "已登记 {{count}} 个脚本",
      "reprobe": "重新试运行",
      "rescan": "重新扫描",
      "running": "运行中…",
      "runtimeOnlyTail": "。跑一遍就能按真实产出登记。",
      "runtimeOnly_other": "有 {{count}} 处存图调用，但文件名只有运行时才知道",
      "sourcePrefix": "注册表来源：",
      "title": "脚本注册表",
      "unresolved": "（对不上磁盘产物：{{names}}）",
      "write": "写入"
    },
    "relink": {
