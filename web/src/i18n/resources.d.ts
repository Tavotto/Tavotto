...
export default interface Resources {
  ...
  "dialogs": {
    "export": {
      ...
      "package": "打包项目（.tavotto）",
      "packaged_other": "已生成项目包 {{name}}（{{count}} 个素材），换机器可从「文档菜单 → 导入项目包」打开",
      "pageMismatch": "当前页面宽 {{current}}mm，与「{{preset}}」的 {{want}}mm 不一致——预设不改页面，需要的话去「画布」标签页调整。",
      "pdfDpiIrrelevant": "PDF 与 dpi 无关",
      "pdfHint": "真矢量，投稿首选",
      "pngHint": "位图，按 dpi 渲染",
      ...
      "svgNote": "规范也接受 SVG，但画布合成只出 PDF/PNG（合成走 PyMuPDF）。要 SVG 请对单张图导出——图内编辑态的写回 / Codex 插件的 tavotto_export 都给真矢量 SVG。",
