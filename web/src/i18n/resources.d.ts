...
export default interface Resources {
  ...
  "errors": {
    "backend": {
      ...
      "source_bake_mismatch": "修改后的 Python 还不能在无运行时 overrides 时独立再现当前 Tavotto 目标。",
      "source_bake_no_overrides": "当前没有可写入 Python 源码的 Tavotto 调整。",
      "source_bake_no_source_change": "编码 Agent 没有修改源码，因此当前 Tavotto 调整尚未写入 Python。",
      "source_bake_prepare_failed": "无法冻结当前 Tavotto 目标用于 source-bake 验证：{{reason}}",
      "source_bake_verified": "修改后的 Python 已能在无运行时 overrides 时独立再现 Tavotto 目标。",
      "source_bake_verify_failed": "源码已经修改，但 source-only 验证未能完成。",
