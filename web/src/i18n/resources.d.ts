...
export default interface Resources {
    ...
    "settings": {
      "about": {
        ...
        "telemetry": {
          ...
          "policy": "隐私政策",
          "sends": {
            "ai_assistant_invoked": "调用改图助手：用的是哪个 Agent。",
  ...
  "inspector": {
    ...
    "element": {
      ...
      "resetElementTitle": "清掉这个元素上的图内修改，回到脚本的原始输出",
      "resetHint": {
        "default": "回到脚本值",
        "size_mm": "恢复脚本原始尺寸",
        "vmax": "自动范围",
      ...
      "resetProp": "恢复{{label}}",
      "resetTitle": "清掉这张图的全部图内修改（含写回时继承的基线），回到脚本的原始输出",
      "resetToScript": "恢复整张图",
      "resetToScriptCount": "恢复整张图 · {{count}} 项",
      "restore": "恢复",
      "restoreGroup": "恢复",
      "retryRender": "重试渲染",
      "scaleApply": "应用",
