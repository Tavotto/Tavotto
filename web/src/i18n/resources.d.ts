...
export default interface Resources {
  "ai": {
    ...
    "panel": {
      ...
      "generating": "正在生成回答",
      "model": "模型",
      "noCli": "未检测到 Codex 或 Claude CLI。可在设置里一键用 npm 安装，或指定其路径。",
      "noPanelHint": "带 { } 标记的面板由脚本生成，助手可以直接修改脚本。",
      "noPanelTitle": "选中一个可参数化面板",
      "none": "—",
      "openAiSettings": "打开 AI 工具设置",
  ...
  "dialogs": {
    ...
    "settings": {
      ...
      "ai": {
        "addEndpoint": "添加接口…",
        "addEndpointTitle": "为 {{agent}} 添加接口",
        "apiKey": "密钥",
        "apiKeySaved": "已保存 {{hint}}，留空则不改",
        "baseUrl": "接口地址",
        "brokenAfter": "的安装（多见于微软商店版的执行别名残留），已跳过：",
        "brokenBefore": "检测到一个",
        "brokenStrong": "无法启动",
        ...
        "delete": "删除",
        "edit": "编辑",
        "editEndpointTitle": "编辑接口 — {{label}}",
        "endpoint": "接口",
        "endpointAria": "{{label}} 使用的接口",
        "installError": {
          "installed_but_not_found": "npm 安装完成，但仍未检测到可用的 CLI。重启应用再试，或在下方手动指定路径。",
          "npm_missing": "找不到 npm：请先安装 Node.js LTS（nodejs.org）。",
          "other": "安装失败，可查看日志或重试。",
          "timeout": "安装超时（网络太慢或 npm 源不可达），可重试。"
        },
        "installLog": "安装日志",
        "installWithNpm": "用 npm 安装 {{label}}",
        "installing": "正在安装…",
        "introAfter": "。",
        "introBefore": "改图助手借用你已装好的 codex / claude 命令行工具。接第三方接口时只在启动它们时临时注入环境变量，",
        "introStrong": "不会改写你自己的 ~/.claude 或 ~/.codex 配置",
        ...
        "notDetected": "未检测到",
        "npmCommand": "npm install -g {{package}}",
        "officialBaseUrl": "（官方默认地址）",
        "officialLogin": "CLI 自带登录态（官方）",
        "pathPlaceholder": "留空 = 自动查找（PATH 与常见安装位置）",
        "preset": "预设",
        "presetAria": "接口预设",
        "presetPlaceholder": "选一个预设填好地址…",
        "redetect": "重新探测",
        "searchedHint": "装在别处就把可执行文件路径填在下面。",
        "searchedSummary": "找过这些位置",
        "wire": "协议",
