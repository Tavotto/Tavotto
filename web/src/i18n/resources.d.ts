...
export default interface Resources {
  "ai": {
    ...
    "panel": {
      ...
      "noCli": "没有可用的编码 Agent。",
      "noPanelHint": "带 { } 标记的图来自脚本，助手可直接修改。",
  ...
  "inspector": {
    ...
    "element": {
      ...
      "alignHdist": "水平等距（≥3）",
      "alignHint": "子图改的是它在图中的占比，文字与图例改的是锚点，都不影响这张图在画布上的尺寸。",
    ...
    "panel": {
      ...
      "bitmapBoth": "翻转和不透明度都会让这张图在导出 PDF 里按位图嵌入。矢量文字不再可选中。",
    ...
    "writeBack": {
      ...
      "annotationsTitle": "压在图上的画布箭头、文字、形状会以矢量按当前位置画进原 PDF，PNG 同步重出。写回后从画布移除，可撤销。",
