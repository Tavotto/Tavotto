...
pub struct ShellText {
    ...
    /// 设置 / 检查更新：macOS 在应用菜单，别的平台分别在「文件」与「帮助」
    ...
    pub file_close_window: &'static str,
    ...
    pub edit_duplicate: &'static str,
    pub edit_delete: &'static str,
    /// 「对齐与分布」子菜单；下面八条的措辞与属性页 `inspector:alignMode.*` 同一套
    pub edit_arrange: &'static str,
    pub align_left: &'static str,
    pub align_hcenter: &'static str,
    pub align_right: &'static str,
    pub align_top: &'static str,
    pub align_vcenter: &'static str,
    pub align_bottom: &'static str,
    pub align_hdist: &'static str,
    pub align_vdist: &'static str,
    pub view: &'static str,
    pub view_zoom_in: &'static str,
    pub view_zoom_out: &'static str,
    pub view_actual_size: &'static str,
    pub view_fit: &'static str,
    pub view_toggle_left: &'static str,
    pub view_toggle_right: &'static str,
    /// 全屏与「窗口」菜单只有 macOS 有（预定义角色在别的平台不支持 / 不合惯例）
    #[cfg_attr(not(target_os = "macos"), allow(dead_code))]
    pub view_fullscreen: &'static str,
    #[cfg_attr(not(target_os = "macos"), allow(dead_code))]
    pub window: &'static str,
    #[cfg_attr(not(target_os = "macos"), allow(dead_code))]
    pub window_minimize: &'static str,
    #[cfg_attr(not(target_os = "macos"), allow(dead_code))]
    pub window_zoom: &'static str,
    #[cfg_attr(not(target_os = "macos"), allow(dead_code))]
    pub window_bring_all: &'static str,
    pub help: &'static str,
    pub help_shortcuts: &'static str,
    pub help_docs: &'static str,
    pub help_report_issue: &'static str,
    pub help_diagnostics: &'static str,
...
const ZH: ShellText = ShellText {
    ...
    view_fit: "适应画布",
    view_toggle_left: "显示/隐藏左栏",
    view_toggle_right: "显示/隐藏右栏",
    view_fullscreen: "进入全屏幕",
    window: "窗口",
    window_minimize: "最小化",
    window_zoom: "缩放",
    window_bring_all: "前置全部窗口",
    help: "帮助",
    help_shortcuts: "快捷键帮助",
    help_docs: "使用文档",
    help_report_issue: "报告问题…",
    help_diagnostics: "导出诊断包…",
...
const EN: ShellText = ShellText {
    ...
    file_save: "Save",
    file_save_layout: "Save as Canvas File…",
    file_export: "Export…",
    ...
    edit_delete: "Delete",
    edit_arrange: "Align and Distribute",
    align_left: "Align Left",
    align_hcenter: "Center Horizontally",
    align_right: "Align Right",
    align_top: "Align Top",
    align_vcenter: "Center Vertically",
    align_bottom: "Align Bottom",
    align_hdist: "Distribute Horizontally",
    align_vdist: "Distribute Vertically",
    view: "View",
    view_zoom_in: "Zoom In",
    view_zoom_out: "Zoom Out",
    view_actual_size: "Actual Size",
    view_fit: "Fit Canvas",
    view_toggle_left: "Show/Hide Left Panel",
    view_toggle_right: "Show/Hide Right Panel",
    view_fullscreen: "Enter Full Screen",
    window: "Window",
    window_minimize: "Minimize",
    window_zoom: "Zoom",
    window_bring_all: "Bring All to Front",
    help: "Help",
    help_shortcuts: "Keyboard Shortcuts",
    help_docs: "Documentation",
    help_report_issue: "Report an Issue…",
    help_diagnostics: "Export Diagnostics…",
...
mod tests {
    ...
    fn english_menu_has_no_cjk() {
        for s in [
            ...
            EN.app_show_all,
            EN.app_settings,
            EN.app_check_updates,
            EN.file_save,
            EN.file_save_layout,
            EN.file_close_window,
            EN.edit_duplicate,
            EN.edit_delete,
            EN.edit_arrange,
            EN.align_left,
