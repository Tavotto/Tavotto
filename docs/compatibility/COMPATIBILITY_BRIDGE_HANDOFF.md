...
- **已合入 main：2026-08-28 03:50Z，squash `8c5a697`**（队列一轮过；
  `backend-platforms` 的 mac + Windows 两条腿**首次执行 `tests/bridge` 全部
  69 条，一次全绿**，`windows-exe-smoke` / `macos-app-smoke` / `package ×3`
  同轮全绿）。
