...
d = OUT / "ENV-08"; shutil.rmtree(d, ignore_errors=True)
...
with p.app_for(proj, work, {}) as app:
    ...
    (OUT / "ENV-08" / "prepare_state.json").write_text(json.dumps(st, ensure_ascii=False, indent=1, default=str))
    ...
    (OUT / "ENV-08" / "dependencies.json").write_text(json.dumps(dep, ensure_ascii=False, indent=1, default=str))
