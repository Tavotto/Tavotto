...
| 选中态 | 只靠底色 | 43 对 outline / filled | 30 个实心孪生 |
...
| 样式（左轨「样式」面板，2026-09-24） | `Paintbrush` | — |
| 回到项目列表（顶栏左上角的主页钮，2026-09-26） | `House` | — |
...
接在已有状态上的地方：左轨七个上下文（`aria-expanded`）、右栏助手钮（`aria-pressed`）、
