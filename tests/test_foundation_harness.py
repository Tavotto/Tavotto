...
def test_the_enforced_set_is_exactly_what_u03_and_u04_promoted_and_each_points_at_a_real_test():
    ...
    # 33 条：32 个 FO + U01-S1；U05：FO23 由 planned → observing（具名任务 private-python-targets.yml，ADR 0064），
    # U05 PR B：FO24 / FO25 / FO26 → enforced
    assert counts == {"planned": 10, "observing": 7, "later": 1, "enforced": 15}
